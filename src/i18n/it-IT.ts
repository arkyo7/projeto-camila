...
export const itIT: Dictionary = {
  ...
  hero: {
    ...
    subheadline:
      "Trattamenti personalizzati di bellezza, estetica viso e benessere, pensati per valorizzare la tua espressione e offrirti un'esperienza dedicata a te.",
  ...
  beauty: {
    ...
    portraitAlt: "Camila Maia che presenta l'identità di Camila Maia Beauty & Benessere",
  ...
  contact: {
    ...
    fields: {
      ...
      email: "E-mail",
      phone: "Telefono",
      phoneCode: "Prefisso internazionale",
